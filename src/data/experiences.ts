...
const experiences: IExperienceItem[] = [
  ...
  },
  {
    ...
    location: "Onsite",
    shortDescription:
      "I had the invaluable opportunity to make a significant impact by revamping and enhancing more than three mobile apps using React Native.",
    description:
      "As a Associate Software Engineer, I had the invaluable opportunity to make a significant impact by revamping and enhancing more than three mobile apps using React Native, showcasing my expertise in the field of mobile development. I played a pivotal role in the development process by deploying RESTful APIs, enabling seamless integration between mobile applications and servers, thereby enhancing the overall user experience and functionality of these apps. Furthermore, I leveraged my skills to integrate Google AdMob into these applications, strategically monetizing them and effectively boosting revenue generation. My contributions as an Associate Software Engineer reflect my dedication to staying current with modern tech stacks and best practices, ultimately delivering meaningful results to the projects I worked on.",
  },
  {
